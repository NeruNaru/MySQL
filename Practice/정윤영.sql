...
/*
>문제2
월급이 12000 초과인 직원의 이름(first_name), 입사일(hire_date), 월급(salary), 사번
(employee_id)을 입사일이 빠른직원부터 출력하세요
월급은 24,000 원 과 같이 출력하세요( 3자리 마다 콤마  그리고 소수첫째자리에서 반올
림)
...
출력 형식은 이름(first_name), 월급(salary), 부서번호(department_id), 부서명
(department_name)
